...
export default function Login() {
  ...
  return (
    <div style={{
      ...
      {/* Atmosphere */}
      <div className="orb" style={{ width: '600px', height: '400px', top: '20%', left: '50%', transform: 'translateX(-50%)', background: 'rgba(37,99,235,0.07)', zIndex: 0 }} />
      ...
      <div className="rise-1" style={{ width: '100%', maxWidth: '420px', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '40px' }}>
          ...
          <p style={{ color: 'var(--ink3)', fontSize: '14px' }}>Sign in to your INVOXL account</p>
        </div>
        ...
        <div className="surface-flat" style={{ padding: '32px' }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            >
              {loading ? (
                <><span style={{ display:'inline-block', width:'14px', height:'14px', border:'2px solid rgba(255,255,255,0.3)', borderTopColor:'#fff', borderRadius:'50%', animation:'spin 0.7s linear infinite' }} /> Signing in...</>
              ) : 'Sign In →'}
            </button>
          </form>
        </div>
        ...
        <p style={{ textAlign: 'center', fontSize: '13px', color: 'var(--ink4)', marginTop: '22px' }}>
          No account?{' '}
          <Link to="/register" style={{ color: 'var(--sapphire3)', fontWeight: '600', textDecoration: 'none' }}>
            Create one →
          </Link>
        </p>
      </div>
